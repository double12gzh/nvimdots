...
info "This script will install double12gzh/nvimdots to:"
echo "${DEST_DIR}"
...
if [[ "${USE_SSH}" -eq "1" ]]; then
	clone_repo "git@github.com:double12gzh/nvimdots.git"
else
	clone_repo "https://github.com/double12gzh/nvimdots.git"
fi
